...
public class MisilAntibalistico extends Misiles implements Dibujable {
	...
	public void destruccion(LinkedList<Explosion> explosionesAgregar, LinkedList<Enemigo> aliadosAEliminar) {

		// sumo el puntaje por destruir misiles enemigos en tiempo real
		PuntajeJugador.actualizarScore(this.puntos);
	...
	// Determina la posicion inicial de cada misil, seteandolo en la posicion
	// inicial de cada base
	...
	public InformacionDibujable getInformacionDibujable() {
		InformacionDibujable info = new InformacionDibujable(this.posicionActual.getPosicionX(),
