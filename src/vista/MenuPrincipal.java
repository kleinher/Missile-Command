...
public class MenuPrincipal extends JFrame{
	...
	public MenuPrincipal() {
		...
		this.setBounds(((alturaPantalla/2)-(anchoFrame/2)), ((anchoPantalla/2)-(altoFrame/2)), anchoFrame, altoFrame);;
		//lo hago visible
	...
	private void inicializarLayout() {
		...
		info.gridwidth = 3; // El área del titulo ocupa dos columnas.
		info.gridheight = 1; // El área del titulo ocupa 2 filas.
